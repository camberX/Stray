...
import dev.voidmark.client.farming.JacobContestTracker.Medal;
...
public final class JacobContestHudRenderer {
	...
	public static void init() {
		HudElementRegistry.attachElementBefore(
			...
			Voidmark.id("jacob_contest"),
			JacobContestHudRenderer::extract
		);
	}
	...
	private static void extract(GuiGraphicsExtractor graphics, DeltaTracker deltaTracker) {
		...
		if (client.player == null || client.options.hideGui || !VoidmarkConfig.get().jacobContestHudEnabled) {
			return;
		}
