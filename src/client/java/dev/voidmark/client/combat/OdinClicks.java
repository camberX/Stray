...
import dev.voidmark.client.mixin.KeyMappingAccessor;
...
public final class OdinClicks {
	...
	public static void rightClick() {
		...
		InputConstants.Key key = ((KeyMappingAccessor) client.options.keyUse).voidmark$boundKey();
	...
	public static void leftClick() {
		...
		InputConstants.Key key = ((KeyMappingAccessor) client.options.keyAttack).voidmark$boundKey();
		KeyMapping.set(key, true);
		KeyMapping.click(key);
		KeyMapping.set(key, false);
	}
	...
	public static void holdAttack() {
		...
		KeyMapping.set(((KeyMappingAccessor) client.options.keyAttack).voidmark$boundKey(), true);
	}
