...
public final class ReleaseNotes {
	...
	public static final Entry[] ENTRIES = {
		...
		new Entry("1.5.37", new String[]{
			"Click GUI Cozette is a little thicker."
		}),
		...
		new Entry("1.5.33", new String[]{
			"Click GUI labels and subsettings use bold Departure Mono."
		}),
		new Entry("1.5.32", new String[]{
			"Click GUI column headers, feature names, and mob names use Departure Mono."
		}),
		...
		new Entry("1.4.71", new String[]{
			"Client watermark version text is smaller. The bottom of S and tray line up."
		}),
		new Entry("1.4.70", new String[]{
			"Client watermark is a large S, the version beside it at the top, and tray under the version."
		}),
		...
		new Entry("1.4.60", new String[]{
			"Click GUI is a column menu. Left click toggles a feature, right click opens its settings, and you can drag a column by its header. Array list sits on the right, one color per feature. Both are on the Menus tab."
		}),
		...
		new Entry("1.4.44", new String[]{
			"Shopping list has a /recipe and /bz option in Garden settings. Clicking an item runs the one you pick."
		}),
		...
		new Entry("1.4.40", new String[]{
			"Crop milestone overlay updates from the Crop Milestones chest. Hover a crop in that menu to switch the overlay to it."
		}),
		...
		new Entry("1.3.42", new String[]{
			"The title screen marble stays still. The drifting backdrop and fade-in are gone."
		}),
		...
		new Entry("1.3.2", new String[]{
			"The title marble slowly flows. Accent tint stays, and the surface keeps a small liquid warp."
		}),
		...
		new Entry("1.2.309", new String[]{
			"Themed chat slides new messages up and eases fading ones out with the glass, instead of popping in and vanishing."
		}),
		...
		new Entry("1.2.290", new String[]{
			"Auto-update always checks stray.gay on launch when the toggle is on, even if Fabric does not expose a .jar origin. The log says when it is off."
		}),
		new Entry("1.2.289", new String[]{
			"Auto-update checks for a new jar while the game is open, not only at launch. A jar already sitting in mods is kept instead of being swept."
		}),
		...
		new Entry("1.2.248", new String[]{
			"2D box ESP corners are no longer brighter than the sides. The four outline strips used to overlap, so alpha stacked at each corner."
		}),
		...
		new Entry("1.2.243", new String[]{
			"Health bars have Full and Empty color pickers. The fill lerps between them as HP drops, on both Stray and CS:GO styles."
		}),
		...
		new Entry("1.2.230", new String[]{
			"Auto Superpairs has Skip books, Skip Titanic, Skip XP dyes, and Skip bottles toggles. Skipped rewards are never paired, so no clicks go to them, and exploring prefers cards you still want."
		}),
		...
		new Entry("1.2.218", new String[]{
			"The End sky black hole is Gargantua-style: edge-on disk, white-hot inner ring, Doppler glow, and the far side bent over the top."
		}),
		...
		new Entry("1.2.215", new String[]{
			"End sky now paints its own stars and galaxy clouds. Vanilla star overlay was invisible on the End texture."
		}),
